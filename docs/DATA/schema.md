As of commit e52064f8605cca7fdec0e0d18ca4ac73bcc570a6

The following models where added to the system
this models are responsible for handling payments and agreements management in the entire system as of now
...
"""
Defines payment rules for a unit. - mode: 'monthly' or 'yearly' - For monthly: allowed_monthly_terms (list of ints), max_months, allow_custom_amount - For yearly: installments (linked via Installment model), show_full_payment_option, enforce_installment_order
"""
