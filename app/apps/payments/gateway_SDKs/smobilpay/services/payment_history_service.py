import requests
from apps.payments.gateway_SDKs.smobilpay.models.payment_history_model import (
    PaymentHistoryModel,
)
    ...
    def fetch_payment_history(self, timestamp_from=None, timestamp_to=None):
        ...
        if timestamp_from:
            try:
                ...
                logging.error(
                    "Invalid type for timestamp_from. It must be a datetime object."
                )
        ...
        if timestamp_to:
            try:
                ...
                logging.error(
                    "Invalid type for timestamp_to. It must be a datetime object."
                )
